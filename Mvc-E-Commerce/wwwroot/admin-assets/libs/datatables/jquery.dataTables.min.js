...
(function (l) {
    ...
    function Kb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            f = '<input type="search" class="productSearch ' + b.sFilterInput + '"/>',
            g = d.sSearch;
    ...
    u.defaults = {
        ...
        oClasses: {},
        oLanguage: {
		oAria: { sSortAscending: ": sütunu artan sıralamayı etkinleştir", sSortDescending: ": sütunu azalan sıralamayı etkinleştir" },
		oPaginate: { sFirst: "İlk", sLast: "Son", sNext: "Sonraki", sPrevious: "Önceki" },
		sEmptyTable: "Tabloda veri yok",
		sInfo: "Gösterilen _START_ - _END_ / _TOTAL_ kayıt",
		sInfoEmpty: "0 girişin 0 ile 0 arası gösteriliyor",
		sInfoFiltered: "(toplam _MAX_ girişten filtrelendi)",
		sInfoPostFix: "",
		sDecimal: "",
		sThousands: ",",
		sLengthMenu: "_MENU_ girişlerini göster",
